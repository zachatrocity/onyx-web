/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6127ed9ba72025cb391b2f917aeb2cb5)
...
declare namespace Cloudflare {
	interface Env {
		...
		JWT_SECRET: "dev-secret-change-in-production-must-be-32-chars-min" | "staging-secret-change-in-production-must-be-32-chars-min" | "your-production-jwt-secret-must-be-32-chars-min";
